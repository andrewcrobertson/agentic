...
Defines the structure and configuration of the root pnpm + Turborepo monorepo, including workspace setup, tooling hooks, CI pipeline, and release infrastructure.
