...
Defines the Express-based API application (`@andrewcrobertson/api`), including its endpoints, logging integration, environment configuration, build, testing, and publishing requirements.
